...
start_minute_bar = f"{current_date}T00:15:00+03:00"
end_minute_bar = f"{current_date}T00:30:00+03:00"
...
with smtplib.SMTP_SSL("smtp.gmail.com", config.EMAIL_PORT, context=context) as server:
    ...
    server.sendmail(config.EMAIL_ADRESS,config.EMAIL_SMS, email_message)